...
<body>
    ...
    <div class="container">
        ...
        <div class="filter-section">
            <form action="${pageContext.request.contextPath}/user/events" method="get">
            ...
            <div class="event-card">
                ...
                <div class="event-content">
                    ...
                    <div class="event-footer">
                        ...
                        <a href="${pageContext.request.contextPath}/user/events/view?id=<%= event.getId() %>" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
            <% 
