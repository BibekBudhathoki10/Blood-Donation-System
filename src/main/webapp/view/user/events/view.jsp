...
<body>
    ...
    <div class="container">
            ...
            <div class="event-sidebar">
                ...
                <div class="event-actions">
                    ...
                    <% } else if(participantCount != null && participantCount >= event.getMaxParticipants()) { %>
                        ...
                        <a href="${pageContext.request.contextPath}/user/events" class="btn btn-secondary">View Other Events</a>
                    <% } else { %>
        ...
        <% } else { %>
            ...
            <p><a href="${pageContext.request.contextPath}/user/events" class="btn btn-primary">Back to Events</a></p>
        <% } %>
    </div>
